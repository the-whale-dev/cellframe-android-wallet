...
- If you wish to use the wallet now you can download the pre-built app-release.apk [here](https://github.com/the-whale-dev/cellframe-android-wallet-imgs/blob/main/app-release.apk)
